...
describe("可信区块链测试：最大交易确认时间", ()=> {
    ...
    it("并行发起转账等操作，并同时记录交易落块时间", (done) => {
                            ...
                            node.api.get("/blocks/getheight")
                                ...
                                .end(function (err, res) {
                                    ...
                                    .end(function (err, res) {
                                        ...
                                        maxTime = Math.max(maxTime, diff2);
                            ...
                            node.api.get("/blocks/getheight")
                                ...
                                .end(function (err, res) {
                                    ...
                                    .end(function (err, res) {
                                        ...
                                        maxTime = Math.max(maxTime, diff3);
                            ...
                            node.api.get("/blocks/getheight")
                                ...
                                .end(function (err, res) {
                                    ...
                                    .end(function (err, res) {
                                        ...
                                        maxTime = Math.max(maxTime, diff4);
                            ...
                            node.api.get("/blocks/getheight")
                                ...
                                .end(function (err, res) {
                                    ...
                                    .end(function (err, res) {
                                        ...
                                        maxTime = Math.max(maxTime, diff5);
        ...
        (err, results) => {
            console.log("交易最大确认时间：" + maxTime + " 秒");
