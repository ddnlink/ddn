---
order: ddn-dapp-chain-sdk
id: ddn-dapp-chain-sdk
title: dapp侧链 SDK
sidebar_label: DDN Dapp chain SDK
---
...
let balance = app.sdb.get('Balance', { address: 'foo', currency: 'DDN' })
/* output:
{
  address: 'foo',
  currency: 'DDN',
...
```
app.sdb.lock('D8BVJ2MH1wjfJpyXeFHRo2j9Ddbgh6uFcA\@nickname'
```
...
```
app.balances.get('D8BVJ2MH1wjfJpyXeFHRo2j9Ddbgh6uFcA\', 'DDN')
/* output:
{
  address: 'D8BVJ2MH1wjfJpyXeFHRo2j9Ddbgh6uFcA\',
  currency: 'DDN',
...
```
app.balances.increase('D8BVJ2MH1wjfJpyXeFHRo2j9Ddbgh6uFcA\', 'DDN', '100000')
```
...
```
app.balances.decrease('D8BVJ2MH1wjfJpyXeFHRo2j9Ddbgh6uFcA\', 'DDN', '100000')
```
...
```
app.balances.transfer('DDN', '100000', 'D8BVJ2MH1wjfJpyXeFHRo2j9Ddbgh6uFcA\', 'DC5kJzMdNDhrnupWX2NGafzMoiwdHiySBe')
```
...
```
app.model.Transfer.findAll({ senderId: 'D8BVJ2MH1wjfJpyXeFHRo2j9Ddbgh6uFcA\'})
/* output:
[
  {
    tid: "50e062f25946d220b924cb5ec6e52e260e44c9417d9f3c8ea041b704e06895f7",
    senderId: "DC5kJzMdNDhrnupWX2NGafzMoiwdHiySBe",
    recipientId:"D8BVJ2MH1wjfJpyXeFHRo2j9Ddbgh6uFcA",
    currency: "rcp.RNC",
    amount: "100000000",
...
```
app.registerContract(1001, 'DDN.postArticle')
```
...
```
app.getContractName(1001) === 'DDN.postArticle'
```
...
```
app.registerFee(1001, '100000', 'DDN')
```
### 8.5 app.getFee(type)
...
> DDN系统中底层存储和上层查询的时间戳均为一个偏移量, 并非实际时间戳, 可以调用这个函数转换为真实的时间戳
